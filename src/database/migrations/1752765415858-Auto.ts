 ...
 export class Auto1752765415858 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<void> {
     await queryRunner.query(`
            ...
            BEGIN
                IF EXISTS (
                    SELECT 1 FROM pg_constraint WHERE conname = 'FK_1900d41dfd389d74d5a5156811e'
                ) THEN
                    ALTER TABLE "lmis_user" DROP CONSTRAINT "FK_1900d41dfd389d74d5a5156811e";
                END IF;
            END
            $$;
        `);
     ...
     await queryRunner.query(`
            ...
            BEGIN
                IF EXISTS (
                    SELECT 1 FROM pg_constraint WHERE conname = 'UQ_1900d41dfd389d74d5a5156811e'
                ) THEN
                    ALTER TABLE "lmis_user" DROP CONSTRAINT "UQ_1900d41dfd389d74d5a5156811e";
                END IF;
            END
            $$;
        `);
